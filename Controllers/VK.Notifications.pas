...
function TNotificationsController.Get(var Products: TVkProducts; Params: TParams): Boolean;
begin
...
function TNotificationsController.Get(var Products: TVkProducts; Params: TVkParamsMarketGet): Boolean;
begin
