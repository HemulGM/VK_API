...
type
  ...
  /// Friends — друзья;
  /// MutualFriends — пользователи, имеющие общих друзей с текущим.
  /// </summary>
  ...
  TVkExtendedField = (PhotoId, Verified, Sex, BirthDate, City, Country,           //
    ...
    WallDefault, OnlineInfo, CanCall, MaidenNameNom, MaidenNameGen,              //
    MaidenNameDat, MaidenNameAcc, MaidenNameIns, MaidenNameAbl,
    // group only
  ...
  /// Forbidden - Отправка сообщений ограничена
  /// </summary>
  ...
  /// <summary>
  /// SharplyNegative — резко негативное;
  /// Negative — негативное;
...
const
  ...
  VkMessageFlags: array[TVkMessageFlag] of Integer = (MF_UNKNOWN_9, MF_UNKNOWN_8,
    ...
    MF_UNKNOWN_1, MF_MEDIA, MF_FIXED, MF_DELETED, MF_SPAM, MF_FRIENDS, MF_CHAT,
  ...
  VkProfileField: array[TVkExtendedField] of string = (
    ...
    'last_name_ins', 'last_name_abl', 'wall_default', 'online_info', 'can_call', 'maiden_name_nom', 'maiden_name_gen',
    'maiden_name_dat', 'maiden_name_acc', 'maiden_name_ins', 'maiden_name_abl', 'place', 'description',
...
begin
  Result := [TVkExtendedField.About, TVkExtendedField.Activities, TVkExtendedField.Activity,
    TVkExtendedField.Books, TVkExtendedField.CanBeInvitedGroup, TVkExtendedField.CanPost,
    TVkExtendedField.CanSeeAllPosts, TVkExtendedField.CanSeeAudio, TVkExtendedField.CanSendFriendRequest,
    TVkExtendedField.CanWritePrivateMessage, TVkExtendedField.Career, TVkExtendedField.City,
    TVkExtendedField.Country, TVkExtendedField.CommonCount, TVkExtendedField.Counters, TVkExtendedField.CropPhoto,
    TVkExtendedField.Domain, TVkExtendedField.Education, TVkExtendedField.exports, TVkExtendedField.FIrstNameNom,
    TVkExtendedField.FirstNameGen, TVkExtendedField.FirstNameAcc, TVkExtendedField.FirstNameIns,
    TVkExtendedField.FirstNameAbl, TVkExtendedField.FollowersCount, TVkExtendedField.FriendStatus,
    TVkExtendedField.Games, TVkExtendedField.HasMobile, TVkExtendedField.HasPhoto, TVkExtendedField.HomeTown,
    TVkExtendedField.Interests, TVkExtendedField.LastNameNom, TVkExtendedField.LastNameGen,
    TVkExtendedField.LastNameDat, TVkExtendedField.LastNameAcc, TVkExtendedField.LastNameIns,
    TVkExtendedField.LastNameAbl, TVkExtendedField.LastSeen, TVkExtendedField.Lists, TVkExtendedField.MaidenName,
    TVkExtendedField.MaidenNameNom, TVkExtendedField.MaidenNameGen,
    TVkExtendedField.MaidenNameDat, TVkExtendedField.MaidenNameAcc, TVkExtendedField.MaidenNameIns,
    TVkExtendedField.Military, TVkExtendedField.Movies, TVkExtendedField.Music, TVkExtendedField.NickName,
    TVkExtendedField.Occupation, TVkExtendedField.Online, TVkExtendedField.OnlineInfo, TVkExtendedField.Personal,
    TVkExtendedField.Photo50, TVkExtendedField.Photo100, TVkExtendedField.Photo200, TVkExtendedField.Photo200Orig,
    TVkExtendedField.Photo400Orig, TVkExtendedField.PhotoBig, TVkExtendedField.PhotoMax, TVkExtendedField.PhotoMaxOrig,
    TVkExtendedField.PhotoMedium, TVkExtendedField.Quotes, TVkExtendedField.Relation, TVkExtendedField.Schools,
    TVkExtendedField.ScreenName, TVkExtendedField.Sex, TVkExtendedField.Site, TVkExtendedField.Status,
    TVkExtendedField.TimeZone, TVkExtendedField.TV, TVkExtendedField.Universities, TVkExtendedField.Verified,
    TVkExtendedField.WallDefault];
end;

class function TVkExtendedFieldsHelper.AllForGroup: TVkExtendedFields;
begin
  Result := [TVkExtendedField.Activity, TVkExtendedField.Addresses, TVkExtendedField.AgeLimits,
    TVkExtendedField.BanInfo, TVkExtendedField.PhotoId, TVkExtendedField.CanCreateTopic,
    TVkExtendedField.CanMessage, TVkExtendedField.CanPost, TVkExtendedField.CanSeeAllPosts,
    TVkExtendedField.CanSeeAudio, TVkExtendedField.CanUploadDoc, TVkExtendedField.CanUploadVideo,
    TVkExtendedField.City, TVkExtendedField.Contacts, TVkExtendedField.Counters, TVkExtendedField.Country,
    TVkExtendedField.CropPhoto, TVkExtendedField.Description, TVkExtendedField.Domain, TVkExtendedField.FixedPost,
    TVkExtendedField.HasPhoto, TVkExtendedField.Photo50, TVkExtendedField.Photo100, TVkExtendedField.Photo200,
    TVkExtendedField.Place, TVkExtendedField.Site, TVkExtendedField.Status,
    TVkExtendedField.Verified, TVkExtendedField.WikiPage];
end;
