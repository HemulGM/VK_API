...
type
  ...
  public
    ...
    /// <summary>
    /// »дентификаторы последних пользователей, писавших в чат
    /// </summary>
    ...
    /// <summary>
    /// »нформаци€ о том, €вл€етс€ ли беседа каналом сообщества
    /// </summary>
    ...
    /// <summary>
    /// ќбъект закреплЄнного сообщени€, если есть
    /// </summary>
  ...
  public  //[JsonReflectAttribute(ctString, rtString, TIntBooleanInterceptor)]
    /// <summary>
    /// »нформаци€ о том, может ли пользователь писать в диалог
    /// </summary>
    ...
    /// <summary>
    /// »дентификатор последнего сообщени€.
    /// </summary>
